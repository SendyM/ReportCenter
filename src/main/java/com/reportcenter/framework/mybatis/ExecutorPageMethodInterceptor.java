package com.reportcenter.framework.mybatis;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (pageField != null)
                        {
                            ...
                            pageUtilEntity.setTotalResult(count);
                            // 通过反射，对实体对象设置分页对象
                            ReflectHelper.setValueByFieldName(parameterObject, "PageUtilEntity", pageUtilEntity);
                        }
                        else
                        {
